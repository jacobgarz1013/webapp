...
def login_form():
    return rx.center(
        rx.vstack(
            rx.heading("Task Management Login", size="6", margin_bottom="1em", text_align="center", color="black"),
            rx.cond(
                State.error_message != "",
            ...
            rx.form(
                rx.vstack(
                    rx.text("Please Log-In or Sign-Up", size="4", text_align="center", color="black", width="100%"),
                    rx.input(
                        placeholder="Group Username",
                        name="username",
                        required=True,
